...
<section class="frontpage">
  ...
  <h1 class="frontpage-title">把 Codex 放进长期协作系统</h1>
  <p class="frontpage-subtitle">给独立开发者和小团队的中文实战手册。这里集中讲任务边界、上下文、权限、工具、扩展、Review、CI 和发布，以及它们在真实项目里如何配合。</p>
...
<div class="quick-grid">
  ...
  <a href="#review-ci-与发布"><div class="card-icon"><GitPullRequest /></div><div class="card-body"><strong>Review 与发布</strong><span>从代码修改一直走到验证、审查和上线。</span></div></a>
